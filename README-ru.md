...
interpt Nun_Lock {...}; interpt ISO_Level2 + Shift {...}; interpt ISO_Lock + AnyOf(Lock+shift) {...};
...
Напомню, что "имя\_скан-кода" описывается в файлах типа **xkb_keycodes** и представляет собой произвольную строчку символов (но длиной не более четырех), ограниченную "угловыми скобками".  
Например,
